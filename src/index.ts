...
const authenticatedActions: string[] = [
  ...
  'api::processed-cart.processed-cart.mine',
  'api::processed-cart.processed-cart.sync',
  'api::processed-cart.processed-cart.clear',
  'api::processed-orders.processed-orders.create',
  'api::processed-orders.processed-orders.status',
  ...
  'api::processed-admin.processed-admin.commissions',
  'api::processed-admin.processed-admin.orders',
  'api::processed-admin.processed-admin.orderIssue',
